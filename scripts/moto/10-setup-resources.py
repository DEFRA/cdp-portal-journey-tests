...
def main() -> None:
    ...
    endpoint = os.getenv("MOTO_URL", "http://localhost:4566")
    assets_dir = Path(os.getenv("MOTO_ASSETS_DIR", "/assets"))

    LOGGER.info("Starting Moto bootstrap | region=%s endpoint=%s assets=%s", region, endpoint, assets_dir)
    ...
    LOGGER.info("Moto resource setup complete")
